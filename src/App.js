...
<head>
  ...
  <meta name="description" content="HTML5 website template"></meta>
  <meta name="keywords" content="global, template, html, sass, jquery"></meta>
  <meta name="author" content="Bucky Maler"></meta>
              ...
              <form className="work-request">
                ...
                <div className="work-request--information">
                  <div className="information-name">
                    <input id="name" type="text" spellcheck="false"></input>
                    <label for="name">Name</label>
                  </div>
                  <div className="information-email">
                    <input id="email" type="email" spellcheck="false"></input>
